# Contributing to rms-psfmodel

Thank you for your interest in contributing to rms-psfmodel! This document provides guidelines and instructions for contributing to the project.
...
2. Clone your fork locally:
   ...
   ```bash
   git clone https://github.com/your-username/rms-psfmodel.git
   cd rms-psfmodel
   ```
...
Thank you for contributing to rms-psfmodel!
